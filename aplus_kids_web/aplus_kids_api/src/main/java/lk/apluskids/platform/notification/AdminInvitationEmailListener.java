...
public class AdminInvitationEmailListener {
    ...
    public AdminInvitationEmailListener(JavaMailSender mailSender, @Value("${aplus.mail.from:}") String from) {
    ...
    public void send(AdminInvitationEmailRequested event) {
        ...
        message.setSubject("You are invited to administer A Plus Kids");
        message.setText("""
            Hello %s,
            ...
            Enter this code on the A Plus Kids administrator invitation verification screen to verify your email and set your password.
