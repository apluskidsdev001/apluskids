...
public class KidsChampSubmissionEntity {
    ...
    @ManyToOne(fetch = FetchType.LAZY) @JoinColumn(name = "last_participant_merge_id") private KidsChampParticipantMergeEntity lastParticipantMerge;
    ...
    public KidsChampParticipantMergeEntity getLastParticipantMerge() { return lastParticipantMerge; }
    ...
    public void mergeIntoRegistered(UserEntity account,ChildProfileEntity child,KidsChampParticipantMergeEntity merge){claim(account,child);lastParticipantMerge=merge;}
    public void mergeIntoGuest(KidsChampGuestParticipantEntity participant,KidsChampParticipantMergeEntity merge){
        user=null;childProfile=null;guestParticipant=participant;guestContact=participant.getContact();lastParticipantMerge=merge;
    }
    public void restoreGuest(KidsChampGuestParticipantEntity participant){
        user=null;childProfile=null;guestParticipant=participant;guestContact=participant.getContact();lastParticipantMerge=null;
    }
}
