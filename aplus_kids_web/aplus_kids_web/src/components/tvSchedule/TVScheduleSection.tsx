      ...
      <div className="mx-auto max-w-[1720px]">
        ...
        <div className="relative">
          <button
            ...
            className="absolute left-1 top-[52px] z-10 hidden h-11 w-11 place-items-center rounded-full border border-white/80 bg-white/75 text-[#071B63] shadow-[0_10px_24px_rgba(7,27,99,0.1)] backdrop-blur-md md:grid"
          >
            &lt;
          </button>
          <div
            ...
            data-focus-kind="schedule-card"
            className="-mx-5 flex snap-x flex-col items-end gap-3 overflow-x-visible px-5 scroll-px-5 scroll-smooth pb-5 [scrollbar-width:none] tablet:-mx-8 tablet:flex-row tablet:gap-5 tablet:overflow-x-auto tablet:px-8 tablet:scroll-px-8 laptop:gap-6 desktop:gap-7 monitor:gap-8 [&::-webkit-scrollbar]:hidden"
          >
          ...
          <button
            ...
            className="absolute right-1 top-[52px] z-10 hidden h-11 w-11 place-items-center rounded-full border border-white/80 bg-white/75 text-[#071B63] shadow-[0_10px_24px_rgba(7,27,99,0.1)] backdrop-blur-md md:grid"
          >
            &gt;
          </button>
        </div>
