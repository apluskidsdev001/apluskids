  ...
  return (
    <section className="bg-white">
      <div className="mx-auto max-w-[1500px]">
        <AdvertisementBanner slot="MARKET_PROMO_BANNER" market />

        <div className="mx-4 mt-6 grid grid-cols-2 gap-4 pb-10 sm:mx-6 sm:mt-7 sm:gap-5 sm:pb-12 md:mx-10 md:pb-14 lg:mx-16 lg:mt-8 lg:grid-cols-4 lg:pb-16">
