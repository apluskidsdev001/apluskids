...
class KidsChampWhatsAppConfigEntity {
    ...
    void save(String version,String phoneId,String accountId,String encrypted){id=1;graphApiVersion=version;phoneNumberId=phoneId;businessAccountId=accountId;accessTokenEncrypted=encrypted;updatedAt=Instant.now();}
