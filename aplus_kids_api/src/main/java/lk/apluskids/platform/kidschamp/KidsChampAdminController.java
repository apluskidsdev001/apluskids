...
public class KidsChampAdminController {
    ...
    @PostMapping("/campaigns") @ResponseStatus(HttpStatus.CREATED) KidsChampAdminService.CampaignResponse createCampaign(JwtAuthenticationToken a,@RequestBody CampaignRequest r){admin(a);return service.createCampaign(subject(a),r.channel(),r.messageTemplate(),r.participantIds());}
    ...
    @PostMapping("/batches/selected") @ResponseStatus(HttpStatus.CREATED) KidsChampAdminService.BatchResponse selectedBatch(JwtAuthenticationToken a,@RequestBody SelectedBatchRequest r){admin(a);return service.createSelectedBatch(subject(a),r.submissionIds());}
    ...
    record SelectedBatchRequest(List<UUID> submissionIds){}
    record ScheduleRequest(LocalDate telecastDate,LocalDate alternateTelecastDate){}
    record TaskRequest(LocalDate date,String title,String details){} record TaskStatusRequest(boolean completed){}
    ...
    record CampaignRequest(String channel,String messageTemplate,List<UUID> participantIds){}
