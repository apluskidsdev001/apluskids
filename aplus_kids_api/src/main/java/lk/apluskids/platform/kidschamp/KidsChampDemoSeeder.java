...
class KidsChampDemoSeeder implements CommandLineRunner {
    ...
    private final KidsChampSubmissionRepository submissions; private final KidsChampGuestContactRepository guests;
    private final KidsChampAdminService admin; private final PasswordEncoder passwords;
    KidsChampDemoSeeder(UserRepository users,RoleRepository roles,ChildProfileRepository children,KidsChampSubmissionRepository submissions,KidsChampGuestContactRepository guests,KidsChampAdminService admin,PasswordEncoder passwords){this.users=users;this.roles=roles;this.children=children;this.submissions=submissions;this.guests=guests;this.admin=admin;this.passwords=passwords;}
